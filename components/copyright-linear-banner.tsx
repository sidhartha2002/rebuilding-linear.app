  ...
  return (
    <div className="fixed right-[4rem] bottom-[4rem] flex w-[65rem] max-w-[95%] items-start rounded-md border border-transparent-white p-8 text-[2rem] backdrop-blur-[12px]">
      <div className="space-y-3">
        <p>
          <strong>⚠️ NOTE:</strong>This is a Demo Website created for Fiverr
          Client as a sample for project on Fiverr. This is not complete work.
          The images are 'random demo' images I've just used as placeholders
          from one of my other projects. Good Luck! 👍
        </p>
        <p>
